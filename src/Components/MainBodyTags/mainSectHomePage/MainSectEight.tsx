...
const MainSectEight = () => {
  return (
    <div className="eight_section__cont">
        <h2 className="heading__tH">Our <span>global</span> reach</h2>
        <div className="flex__class_tH">
            <div className="global_ads__tH">
                <div className="ads_text__tH">
                    <h6>
                        <a href='https://support.flutterwave.com/en/articles/3632719-accepted-currencies'>30+ Currencies</a>
                    </h6>
                    <p>
                ...
                <div className="ads_text__tH">
                    <h6>20M+ API calls</h6>
                    <p>
                        API calls per day, peaking at 231 requests per seconds
                    </p>
                </div>
                <div className="ads_text__tH">
                    <h6>500k+ payments daily</h6>
                    <p>
                        Average number of payments processed daily
                    </p>
                </div>
                <div className="ads_text__tH">
                    <h6>15+ payment options</h6>
                    <div className='flex_listItems__tH'>
                        <ul className='list__tH listOne__tH'>
                            <li>Debit & Credit cards</li>
                            <li>Mobile money</li>
                            <li>M-Pesa</li>
                            <li>Bank Transfer</li>
                        </ul>
                        <ul className='list__tH listTwo__tH'>
                            <li>Bank Account</li>
                            <li>POS</li>
                            <li>VISA QR</li>
                            <li>USSD</li>
            ...
            <div className="global_ads__tH">
                <div className="flex__img_globe">
                    <div className="img__globe_tH">
                        <img src={globalNet} alt="globe network" width="100%" height="100%" />
                    </div>
                    <div className="img__globe_tH">
                        <img src={globalNet} alt="globe network" width="100%" height="100%" />
                    </div>
                    <div className="blink_spot__cont">
                        <span className="blink__spot_tH"></span>
                        <span className="blink__spot_tH"></span>
                        <span className="blink__spot_tH"></span>
                        <span className="blink__spot_tH"></span>
                        <span className="blink__spot_tH"></span>
